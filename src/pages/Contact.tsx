...
const Contact: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center">Contáctanos</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="subject" className="block mb-1">Asunto</label>
              <input
                type="text"
                id="subject"
                name="subject"
        ...
        <div>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Síguenos en redes sociales</h2>
